...
def read_pcap():
    testcap = open(r'C:\Users\Johannes Persson\Documents\Skola\Websäkerhet EDAP05\Kod\EITN41\B2\B2\cia.log.13372.pcap', 'rb')
    ...
    while i < size:
        ...
        if len(disjoint_sets) != nbr_of_partners and len(outgoing_sets) > 0 and collect_out_set:
            ...
            while j < len(outgoing_sets) - 1 and disjoint:
                print(outgoing_sets[j] in outgoing_sets[-1] or outgoing_sets[j] == outgoing_sets[-1])
...
print(find_partners(packet_list))
